...
最终交付物：
- `license-builder/`：版本化 shell license 生成器
...
- CI downloads the upstream installer from Duke, verifies SHA-256, builds the Arch package inside an Arch Linux container, and uploads the package plus the shell builder script to GitHub Releases.
